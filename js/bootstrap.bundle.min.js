...
!(function (t, e) {
    ...
    class bi {
        ...
        _getElement() {
            if (!this._element) {
                ...
                (t.className = this._config.className), this._config.isAnimated, (this._element = t);
            }
    ...
    class Mn extends B {
        ...
        show() {
            j.trigger(this._element, "show.bs.bwasp-toast").defaultPrevented ||
                (this._clearTimeout(),
                ...
                this._queueCallback(
                    () => {
                        this._element.classList.remove(In), j.trigger(this._element, "shown.bs.bwasp-toast"), this._maybeScheduleHide();
                    },
                    this._element,
                    this._config.animation
                ));
        ...
        hide() {
            this._element.classList.contains(Nn) &&
                (j.trigger(this._element, "hide.bs.bwasp-toast").defaultPrevented ||
                    (this._element.classList.add(In),
                    this._queueCallback(
                        () => {
                            this._element.classList.add(Sn), this._element.classList.remove(In), this._element.classList.remove(Nn), j.trigger(this._element, "hidden.bs.bwasp-toast");
                        },
                        this._element,
                        this._config.animation
                    )));
        ...
        _setListeners() {
            j.on(this._element, "mouseover.bs.bwasp-toast", (t) => this._onInteraction(t, !0)),
                j.on(this._element, "mouseout.bs.bwasp-toast", (t) => this._onInteraction(t, !1)),
                j.on(this._element, "focusin.bs.bwasp-toast", (t) => this._onInteraction(t, !0)),
                j.on(this._element, "focusout.bs.bwasp-toast", (t) => this._onInteraction(t, !1));
        }
        _clearTimeout() {
